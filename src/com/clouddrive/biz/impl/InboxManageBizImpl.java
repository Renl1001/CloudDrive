...
public class InboxManageBizImpl implements InboxManageBiz {
	...
	@Override
	public String insertInbox(String userName, String uuidName, String illustrate) {
		String currentTime = new CurrentTime().getDateString();
		String key  = new CreateKey().createPassWord(8);
		
		Inbox inbox = new Inbox(userName, uuidName, illustrate, currentTime, currentTime, key);
